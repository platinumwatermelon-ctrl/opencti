...
import VocabularyPopover from '@private/components/settings/attributes/VocabularyPopover';
import { VocabulariesLinesPaginationQuery, VocabulariesLinesPaginationQuery$variables } from '@private/components/settings/__generated__/VocabulariesLinesPaginationQuery.graphql';
