...
import { ContainerStixDomainObjectsLines_container$key } from '@private/components/common/containers/__generated__/ContainerStixDomainObjectsLines_container.graphql';
