...
import { DraftsLinesPaginationQuery, DraftsLinesPaginationQuery$variables } from '@private/components/drafts/__generated__/DraftsLinesPaginationQuery.graphql';
import DraftCreation from '@private/components/drafts/DraftCreation';
