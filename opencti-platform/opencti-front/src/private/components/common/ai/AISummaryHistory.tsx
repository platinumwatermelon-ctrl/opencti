...
import { AISummaryHistorySubscription, AISummaryHistorySubscription$data } from '@private/components/common/ai/__generated__/AISummaryHistorySubscription.graphql';
